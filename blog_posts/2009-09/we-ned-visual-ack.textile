...
Format: Textile
--------------
"ack":http://betterthangrep.com/ is a nifty improvement over grep written in perl. However, it's a command-line app and those days dumping results into terminal window isn't very inspired.
