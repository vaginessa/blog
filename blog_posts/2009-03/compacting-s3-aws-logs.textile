...
It took me a few hours to get right, so in the spirit of sharing, "here it is":http://code.google.com/p/kjk/source/browse/trunk/scripts/compact-s3-logs.py. You'll have to change a few things in the source:
