...
Resources:
* "diff library for c# (Neil Frasner)":http://code.google.com/p/google-diff-match-patch/
* http://bazaar.launchpad.net/~bzr-pqm/bzr/bzr.dev/annotate/head:/bzrlib/_patiencediff_c.c
* http://bazaar.launchpad.net/~bzr-pqm/bzr/bzr.dev/annotate/head:/bzrlib/_patiencediff_py.py
