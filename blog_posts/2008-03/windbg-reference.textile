...
dpu $addr L4 - try to resolve 4 pointer values at $addr as unicode strings
...
wt - like p but also gathers stats about the function (how many instructions, what has been called)
