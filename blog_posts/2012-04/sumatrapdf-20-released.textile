...
Format: Textile
--------------
"SumatraPDF":http://blog.kowalczyk.info/software/sumatrapdf is a multi-format PDF, XPS, ebook (MOBI), DjVu etc. reader for Windows and "we":http://www.ohloh.net/p/4623/contributors are pleased to announce version 2.0.
...
Sumatra has always been a small and fast program and because we applied "extreme size optimization techniques":http://code.google.com/p/sumatrapdf/source/browse/trunk/src/ucrt/readme.txt, it's smaller than ever. If we didn't apply our extreme size-reduction techniques, the installer would be bigger by 9% (which is around 400 kB) (as a bonus, the size-reducing code we developed is available to other programmers under liberal BSD license).
