...
Format: Textile
--------------
"Volante":http://blog.kowalczyk.info/software/volante/database.html is a small, fast, object-oriented, embeddable database designed for seamless integration with C# (and other .NET languages). Today I've made a first public release.
...
Thankfully, I didn't have to do that. What I needed already existed in the form of "Perst":http://en.wikipedia.org/wiki/Perst project.
