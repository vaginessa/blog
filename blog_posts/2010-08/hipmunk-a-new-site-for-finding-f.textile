...
Format: Textile
--------------
A new web service "Hipmunk":http://www.hipmunk.com/ just launched. They offer a new interface for finding flights (which then can be booked through Orbitz).
...
For now "Hipmunk":http://www.hipmunk.com/ is certainly my new preferred flight finding website.
